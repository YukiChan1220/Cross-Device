...
SEPARATORS = [b'\xA1' * 8, b'\xA2' * 8, b'\xA3' * 8, b'\xA4' * 8, b'\xA5' * 8]
SEPARATOR_TO_LINE_PREFIX = {SEPARATORS[0]: '1', SEPARATORS[1]: '2', SEPARATORS[2]: '3', SEPARATORS[3]: '4', SEPARATORS[4]: '5'}
...
def print_line_count():
    ...
    while True:
        ...
        print(f"data rate: {line_count / 5} Hz")
        line_count = 0  # 重置计数器
